...
#     "SECRET_KEY", "django-insecure-lj%5&w31n23d*3)ev29gj&rhth^dc^5*$0^j#2&o8677dpvj73"
# )
...
#         "DIRS": [BASE_DIR / "templates"],  # React build templates (optional)
#         "APP_DIRS": True,
#         "OPTIONS": {
#             "context_processors": [
...
MIDDLEWARE = [
    ...
    "django.contrib.messages.middleware.MessageMiddleware",
    "django.middleware.clickjacking.XFrameOptionsMiddleware",
    # "Auth.ratelimit.RateLimitMiddleware"
